...
[x] Developed a Hybrid Deep Learning Framework for Legal Judgment Prediction to predict whether a legal appeal will be accepted or rejected.
[x] Integrated Role-Weighted InLegalBERT and Entity-Aware BiLSTM with Role-Biased Attention to capture both legal semantics and document structure.
